...
def create_view_of_delft_info_file(data_path,
                           pkl_prefix='view_of_delft',
                           save_path=None,
                           relative_path=True):
    ...
    vod_infos_train = get_kitti_image_info(
        data_path,
        training=True,
        velodyne=True,
        calib=True,
    ...
    _calculate_num_points_in_gt(data_path, vod_infos_train, relative_path)
    filename = save_path / f'{pkl_prefix}_infos_train.pkl'
    print(f'View of Delft info train file is saved to {filename}')
    mmcv.dump(vod_infos_train, filename)
    vod_infos_val = get_kitti_image_info(
        data_path,
        training=True,
        velodyne=True,
        calib=True,
        ...
        image_ids=val_img_ids,
        relative_path=relative_path)
    _calculate_num_points_in_gt(data_path, vod_infos_val, relative_path)
    filename = save_path / f'{pkl_prefix}_infos_val.pkl'
    print(f'View of Delft info val file is saved to {filename}')
    mmcv.dump(vod_infos_val, filename)
    filename = save_path / f'{pkl_prefix}_infos_trainval.pkl'
    print(f'View of Delft info trainval file is saved to {filename}')
    mmcv.dump(vod_infos_train + vod_infos_val, filename)

    vod_infos_test = get_kitti_image_info(
        data_path,
        training=False,
        label_info=False,
        velodyne=True,
        ...
        relative_path=relative_path)
    filename = save_path / f'{pkl_prefix}_infos_test.pkl'
    print(f'View of Delft info test file is saved to {filename}')
    mmcv.dump(vod_infos_test, filename)
