...
class ViewOfDelftDataset(Custom3DDataset):
    r"""ViewOfDelftDataset.

    This class serves as the API for experiments on the `View Of Delft Dataset
    <https://tudelft-iv.github.io/view-of-delft-dataset/>`_.
    ...
    def __init__(self,
                 ...
                 test_mode=False,
                 pcd_limit_range=[0, -25.6, -3, 51.2, 25.6, 1],
                 **kwargs):
        super().__init__(
            data_root=data_root,
            ann_file=ann_file,
    ...
    def get_ann_info(self, index):
        ...
        gt_bboxes_3d = CameraInstance3DBoxes(gt_bboxes_3d).convert_to(
            self.box_mode_3d, np.linalg.inv(rect @ Trv2c)) # TODO Issue 1 Magic box
    ...
    def bbox2result_kitti2d(self,
        ...
        if submission_prefix is not None:
            ...
            mmcv.mkdir_or_exist(submission_prefix)
            print(f'Saving View of Delft submission to {submission_prefix}')
